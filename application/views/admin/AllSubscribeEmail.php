...
<div class="panel-body">
	<form role="form" method="post" action="<?php echo SURL1;?>Subscribers/allsubscribe" class="form-horizontal form-groups-bordered"  enctype="multipart/form-data">

       <div class="form-group">
			<label for="field-1" class="col-sm-3 control-label">User</label>
			<div class="col-sm-5">
				<input type="text" readonly name="subject" maxlength="20" class="form-control" autofocus id="field-1" value="All User"  >
			</div>
		</div>
		<div class="form-group">
