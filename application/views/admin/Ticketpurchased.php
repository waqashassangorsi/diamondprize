...
<div style="text-align: right;">
			<a href="<?php echo base_url();?>admin/Language/AddLanguage" class="btn btn-success btn-icon">
				Add
	...
	<tbody>
        ...
        ?>
				<tr class="odd gradeX">
					...
					<td class="center">
						<a href="<?php echo base_url()?>admin/Language/edit/<?php echo $value['id']; ?>" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
...
<script type="text/javascript">
	$(document).on('click','.dlt',function(){
		...
		if(response == true){
			window.location.href = "<?php echo SURL1;?>Language/delete/"+id;
		}
	});
</script>
